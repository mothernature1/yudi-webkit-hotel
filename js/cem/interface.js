function initData(callback){
	...
	//list.push({name:lang.index.music,tar:'music',disName:lang.index.musicDis,url:'album/index.html',image:'images/base/fm_logo.png'});
	list.push({name:lang.index.radio,tar:'radio',disName:lang.index.radio,url:'radio/index.html',image:'images/base/fm_logo.png',});

	//list.push({name:'Youtube',tar:'youtube',disName:'Youtube',url:'youtube/index.html',image:'images/base/drama-logo.png'});
