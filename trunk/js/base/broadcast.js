...
function message_marquee(){
	$("#pagewrap").append("<div class='broadcast'></div>");
	var con = '<span></span>';
		con += '<marquee scrollamount="10" direction="left"><p class="broadcastTest"></p></marquee>';
	
        
	var mes = $.getSession("messageList"); 
	...
	if(mesList!=''){
		$(".broadcast").html(con)
		var content=mesList[0].content.replace("\r\n","");
		$(".broadcastTest").html(content.replace(/[ ]/g,""))	
	}
}
