function initData(callback){
	...
	list.push({name:lang.index.chineseChannel,tar:'Chinese Channel',disName:lang.index.chineseChannelDis,url:'live/index.html',image:'images/base/chinac01.png'});
...
function getAppList(){
	...
	if(config.showXiamiMusic){
		appList.push({name:lang.index.xiamiMusic,url:'xiami/index.html',logo:'images/apps/music.png',});
	}
	
	if(config.showRadio){
		appList.push({name:lang.index.douban,url:'music/index.html',logo:'images/apps/radio_logo.png',});
	}
