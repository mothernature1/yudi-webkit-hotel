var lang = {
	...
	xiami:{
		firstLetter:"The first letter of name",
		...
		chineseMaleArtist:'Chinese Male',
		chineseFemaleArtist:'Chinese Female',
		chineseBand:'Chinese Band',
		japaneseMaleArtist:'Japanese Male',
		japaneseFemaleArtist:'Japanese Female',
		japaneseBand:'Japanese band',
		koreanMaleArtist:'Korean Male',
		koreanFemaleArtist:'Korean Female',
		koreanBand:'Korean Band',
		occidentMaleArtist:'Occident Male',
		occidentFemaleArtist:'Occident Female',
		occidentBand:'Occident Band',
		otherMaleArtist:'Other Males',
		otherFemaleArtists:'Other Females',
		otherBands:'Other Bands',
		favorite_tit:'Oops! You haven\'t added any program to this section.</br>You may add programs to Favorite by using the green button in playback page.',
	 },	
	 local:{
		refresh:'Refresh',
		media_nav:'by Media Type',
		folder_nav:'by Folder',
		media_video:'Video Media Library',
		media_music:'Music Media Library',
		media_picture:'Picture Media Library',
		video_Audio:"Audio",
		video_Subtitle:"Subtitle",
		Setting:"Screen settings",
		mymusic:"My Music",
		retrievingFile:"Retrieving files, please wait!",
		noFile:"No file",
		insertDisk:"Please insert U disk",
	},
}